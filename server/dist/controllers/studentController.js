...
const createStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const savedStudent = yield studentRepository.save(newStudent); // save() returns the saved entity
...
const updateStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (student) {
            ...
            const updatedStudent = yield studentRepository.save(student); // Save the updated student
